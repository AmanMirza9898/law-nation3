...
//               Sign in to access your saved research, manage submissions, and
//               stay connected.
//             </p>
//           </div>
//         </div>
...
function LoginContent() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch("https://law-nation3.onrender.com/api/auth/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          if (redirectPath) {
            ...
            router.push("/home"); // Changed to your home route
          }
        }, 1500);
      } else {
        toast.error(data.message || "Invalid credentials", {
...
// --- PART 2: Default Export with Suspense Wrapper ---
export default function Login() {
  return (
    <Suspense
      fallback={
